    ...
    <div className="risk-management">
      <div className="risk-header">
        ...
        <p className="risk-subtitle">
          Sample disruption context for the Rotterdam scenario.
        </p>
      </div>
      ...
      <div className="risk-content">
        ...
        <div className="risk-map">
          <svg
            ...
            role="img"
            aria-label="Illustrative disruption hotspot"
          >
        ...
        <div className="risk-events">
          {riskEvents.map((event, index) => (
            <div
              key={index}
              className={`risk-event severity-${event.severity}`}
            >
              ...
              <div className="event-description">
                <strong>Suggested response:</strong> {event.description}
              </div>
            </div>
          ))}
        </div>
